...
public class Administrador extends Usuario {
	...
	public Administrador(int id, String usuario, String senha, String nome, int apto, int telefone, String email, Veiculo veiculo, int moradores, Date data, Boolean ativado) {
